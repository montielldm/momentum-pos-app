import { Settings, Ticket, House, Carrot, CircleUserRound } from "lucide-react"
                    ...
                    <SidebarGroupContent>
                        <SidebarMenu>
                            <SidebarMenuItem className="flex items-center gap-2 px-2 pt-2 pb-[4px]">
                                ...
                                <span className={`font-bold text-md whitespace-nowrap ${state !== "expanded" ? 'hidden' : ''}`}>Momentum POS</span>
                            </SidebarMenuItem>
                                ...
                                state !== "collapsed" && (
                                    <li className=" px-2 flex items-center gap-2">
                                        <div className="w-full">
                                            <span className="uppercase text-[11px] font-medium text-muted-foreground italic">sales</span>
                                        </div>
                                    </li>
                                )
                            }
                            ...
                            <Separator orientation="horizontal" />
                            {
                                state !== "collapsed" && (
                                    <li className=" px-2 flex items-center gap-2">
                                        <div className="w-full">
                                            <span className="uppercase text-[11px] font-medium text-muted-foreground italic">CORES</span>
                                        </div>
                                    </li>
                                )
                            }
